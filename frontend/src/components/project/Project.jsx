            ...
            <div className="flex -space-x-2 overflow-hidden mb-2 gap-2 p-2">
              {project.collaborators && project.collaborators.length === 0 ? (
                ...
                project.collaborators.map((collaborator) => (
                  <Collaborator key={uuidv4()} name={collaborator.name} />
                ))
              )}
            </div>
          </div>
            ...
            {project &&
              ...
              project.owner._id ===
                ...
                <>
                  <MoreVertIcon
                    onClick={() =>
                      visible === "" ? setVisible("hidden") : setVisible("")
                    }
                    className="text-gray-600 float-right mb-2 mt-2 cursor-pointer"
                  />
                  <button
                    type="button"
